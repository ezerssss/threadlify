...
function Kanban(props: PropsInterface) {
  ...
  return (
    <>
                          ...
                          {columnId === "new" && (
                            <Tooltip>
                              ...
                              <TooltipContent side="bottom" className="max-w-[280px]">
                                <p>
                                  Rechecks relevance for unseen posts. Useful after updating profile, strategy, or
                                  keywords so recommendations match their latest preferences.
                                </p>
                              </TooltipContent>
                            </Tooltip>
                          )}
      ...
      <NotRelevantFeedbackSheet onSuccess={handleNotRelevantFeedbackSuccess} managedUserId={managedUserId} />
      <PopUpContent
