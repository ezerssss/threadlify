...
export function EmptyObjectives() {
  ...
  function handleContactSupport() {
    const subject = encodeURIComponent("No Data After Scan - Insights");
    const body = encodeURIComponent(
      `Hello Threadlify Support,

I recently upgraded to ${userData?.subscription.plan ?? "pro"} and performed a scan, but I'm still not seeing any insights.
  ...
  return (
    <Empty>
      <EmptyHeader>
        ...
        <EmptyDescription>
          {isProOrPremium
            ? "Start a scan to gather market data and generate actionable insights from real user posts."
